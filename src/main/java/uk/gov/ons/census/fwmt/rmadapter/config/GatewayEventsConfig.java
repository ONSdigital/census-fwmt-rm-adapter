...
public class GatewayEventsConfig {
  ...
  public static final String REDIS_NO_RECORD_FOUND = "REDIS_NO_RECORD_FOUND";
  ...
  public GatewayEventManager gatewayEventManager() {
    ...
    gatewayEventManager.addErrorEventTypes(
        new String[] {INVALID_ACTION_INSTRUCTION, FAILED_TO_UNMARSHALL_ACTION_INSTRUCTION,
            FAILED_TO_MARSHALL_CANONICAL, REDIS_NO_RECORD_FOUND, RABBIT_QUEUE_DOWN, REDIS_SERVICE_DOWN});
